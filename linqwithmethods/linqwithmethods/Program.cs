...
namespace linqwithmethods
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Employees.diplaywithempapp(sortedlist(listOfEmployees), "linkwith methods");

        }

        public static List<Employees>sortedlist(List<Employees> employees)
        {
